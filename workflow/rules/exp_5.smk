...
def list_of_genomes_to_index_exp5(wildcards):
    ...
    """
    input_files = []
    for num in range(1, num_datasets_exp5+1):
...
rule build_spumoni_full_index_exp5:
    input:
        "exp5_full_ref/full_ref.fa"
    output:
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.thrbv.spumoni",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.thrbv.ms",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.pmlnulldb",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.msnulldb"
    shell:
        """
...
rule build_spumoni_promoted_index_exp5:
    ...
    output:
        ...
        "exp5_indexes/spumoni_promoted_k{k}_w{w}/spumoni_full_ref.bin.thrbv.ms",
        "exp5_indexes/spumoni_promoted_k{k}_w{w}/spumoni_full_ref.bin.pmlnulldb",
        "exp5_indexes/spumoni_promoted_k{k}_w{w}/spumoni_full_ref.bin.msnulldb"
    shell:
        """
        # Copy over reference file to specific folder, and build the index
...
rule build_spumoni_dna_index_exp5:
    ...
    output:
        ...
        "exp5_indexes/spumoni_dna_k{k}_w{w}/spumoni_full_ref.fa.thrbv.ms",
        "exp5_indexes/spumoni_dna_k{k}_w{w}/spumoni_full_ref.fa.pmlnulldb",
        "exp5_indexes/spumoni_dna_k{k}_w{w}/spumoni_full_ref.fa.msnulldb"
    shell:
        """
        # Copy over reference file to specific folder, and build the index
...
rule extract_first_batch_of_data_for_spumoni_full_index_exp5:
    input:
        "exp5_read_sets/pos_reads.fa",
        "exp5_read_sets/null_reads.fa"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa"
    shell:
        """
        python3 {repo_dir}/src/extract_batch.py -i exp5_read_sets/{wildcards.class}_reads.fa \
        -n 1 -s 180 -a --spumoni > {output}
...
rule classify_first_batch_using_spumoni_full_index_exp5:
    input:
        ...
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa.report",
...
rule determine_reads_to_keep_for_second_batch_spumoni_full_index_exp5:
    input:
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa.report"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa.reads_to_keep"
    shell:
        """
        python3 {repo_dir}/src/process_spumoni_report.py -i {input[0]} -l {input[0]} -o {output}
        """
...
rule extract_second_batch_of_data_for_spumoni_full_index_exp5:
    input:
        "exp5_read_sets/pos_reads.fa",
        "exp5_read_sets/null_reads.fa",
        "exp5_results/spumoni_full_index/{class}_reads/batch_1/curr_batch.fa.reads_to_keep"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa"
    shell:
        """
        python3 {repo_dir}/src/extract_batch.py -i exp5_read_sets/{wildcards.class}_reads.fa \
        -n 2 -s 180 -k {input[2]}  --spumoni > {output}
...
rule classify_second_batch_using_spumoni_full_index_exp5:
    input:
        ...
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa.report",
...
rule determine_reads_to_keep_for_third_batch_spumoni_full_index_exp5:
    input:
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa.report"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa.reads_to_keep"
    shell:
        """
        python3 {repo_dir}/src/process_spumoni_report.py -i {input[0]} -l {input[0]} -o {output}
        """
...
rule extract_third_batch_of_data_for_spumoni_full_index_exp5:
    input:
        "exp5_read_sets/pos_reads.fa",
        "exp5_read_sets/null_reads.fa",
        "exp5_results/spumoni_full_index/{class}_reads/batch_2/curr_batch.fa.reads_to_keep"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa"
    shell:
        """
        python3 {repo_dir}/src/extract_batch.py -i exp5_read_sets/{wildcards.class}_reads.fa\
        -n 3 -s 180 -k {input[2]}  --spumoni > {output}
...
rule classify_third_batch_using_spumoni_full_index_exp5:
    input:
        ...
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa.report",
...
rule determine_reads_to_keep_for_fourth_batch_spumoni_full_index_exp5:
    input:
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa.report"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa.reads_to_keep"
    shell:
        """
        python3 {repo_dir}/src/process_spumoni_report.py -i {input[0]} -l {input[0]} -o {output}
        """
...
rule extract_fourth_batch_of_data_for_spumoni_full_index_exp5:
    input:
        "exp5_read_sets/pos_reads.fa",
        "exp5_read_sets/null_reads.fa",
        "exp5_results/spumoni_full_index/{class}_reads/batch_3/curr_batch.fa.reads_to_keep"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_4/curr_batch.fa"
    shell:
        """
        python3 {repo_dir}/src/extract_batch.py -i exp5_read_sets/{wildcards.class}_reads.fa\
        -n 4 -s 180 -k {input[2]}  --spumoni > {output}
...
rule classify_fourth_batch_using_spumoni_full_index_exp5:
    input:
        ...
        "exp5_results/spumoni_full_index/{class}_reads/batch_4/curr_batch.fa"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_4/curr_batch.fa.report",
...
rule determine_reads_to_keep_for_fifth_batch_spumoni_full_index_exp5:
    input:
        "exp5_results/spumoni_full_index/{class}_reads/batch_4/curr_batch.fa.report"
    output:
        "exp5_results/spumoni_full_index/{class}_reads/batch_4/curr_batch.fa.reads_to_keep"
    shell:
        """
        python3 {repo_dir}/src/process_spumoni_report.py -i {input[0]} -l {input[0]} -o {output}
        """
...
rule analyze_spumoni_full_index_results_into_csv_line_exp5:
    input:
        "exp5_read_sets/pos_reads.fa",
        "exp5_read_sets/null_reads.fa",
        "exp5_results/spumoni_full_index/pos_reads/batch_4/curr_batch.fa.reads_to_keep",
        "exp5_results/spumoni_full_index/null_reads/batch_4/curr_batch.fa.reads_to_keep",
        "exp5_results/spumoni_full_index/pos_reads/batch_1/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/pos_reads/batch_2/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/pos_reads/batch_3/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/pos_reads/batch_4/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/null_reads/batch_1/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/null_reads/batch_2/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/null_reads/batch_3/curr_batch.fa.resources",
        "exp5_results/spumoni_full_index/null_reads/batch_4/curr_batch.fa.resources",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.thrbv.spumoni",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.pmlnulldb",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.thrbv.ms",
        "exp5_indexes/spumoni_full_index/spumoni_full_ref.fa.msnulldb"
